      ...
      <template #fallback>
        <section class="relative overflow-hidden bg-ink-950">
          ...
          <div class="relative z-10 px-4 py-24 md:py-32 text-center">
            ...
            <h1
              class="mt-4 text-4xl md:text-7xl font-serif font-semibold tracking-tight leading-[1.05] text-canvas"
            >
              Cetak Banner, <span class="text-gold-400">Presisi</span> Setiap Warna
            </h1>
            <p class="mx-auto mt-4 max-w-xl text-sm md:text-base leading-relaxed text-canvas/80">
